...
Given a json tree and a command path (for example {\ttfamily /v1/chain/get\+\_\+info}), and E\+OS blockchain communication port (for example {\ttfamily 8888}), and E\+OS blockchain server name (for example {\ttfamily localhost}), gets E\+OS blockchain responce.
...
Given a json and a command path, for example {\ttfamily /v1/chain/get\+\_\+info}, gets E\+OS blockchain responce.
